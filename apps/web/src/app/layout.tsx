...
const THEME_BOOT_SCRIPT = `(function(){try{var t=localStorage.getItem('chorify-theme');if(t==='ember'||t==='highland'||t==='family'||t==='glacier'||t==='honey'||t==='garden'||t==='rose'||t==='buna'){document.documentElement.dataset.theme=t;}}catch(e){}})();`;
