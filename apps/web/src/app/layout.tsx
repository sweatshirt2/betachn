...
const THEME_BOOT_SCRIPT = `(function(){try{var t=localStorage.getItem('chorify-theme');if(t==='ember'||t==='highland'||t==='family'||t==='glacier'){document.documentElement.dataset.theme=t;}}catch(e){}})();`;
