...
export type Dict = {
  ...
  coach: {
    ...
    stepTodayTitle: string;
    stepTodayBody: string;
    stepCreateTitle: string;
    stepCreateBody: string;
    stepPantryTitle: string;
    stepPantryBody: string;
    replay: string;
    replayHint: string;
  };
  settings: {
...
export const en: Dict = {
  ...
  auth: {
    ...
    googleFailed:
      "Google sign-in did not go through. Try again, or use your household code.",
  ...
  today: {
    ...
    whySeeingHint:
      "This shows because the chore is due today and you are a member of the household. You can change schedules any time.",
  },
  chores: {
    title: "Chores",
    mine: "Mine",
    ...
    proofModeHint:
      "Require a photo proof before this chore can be marked done.",
  ...
  household: {
    ...
    permissionsHint:
      "Switches start from the role. Toggling twice returns to the role default.",
  },
  perms: {
    domains: {
      household: "Household",
  ...
  ops: {
    routines: "Routines",
    routinesHint:
      "Buckets that organize chores — they never schedule anything themselves.",
    home: "Home",
    rooms: "Rooms",
    assets: "Assets",
    supplies: "Supplies",
  ...
  notify: {
    ...
    swapRequested:
      "{{who}} asks you to take “{{title}}” — open Today to respond.",
  ...
  lock: {
    ...
    recoverWarning:
      "Offline-only household? Resetting erases data on this device.",
  },
  cal: {
    m1: "Meskerem",
    m2: "Tikimt",
  ...
  coach: {
    ...
    stepTodayTitle: "Swipe through your day",
    stepTodayBody:
      "Swipe right to finish a chore, left to skip it. Tap the circle to check off — buttons always work too.",
    stepCreateTitle: "Add anything with one button",
    stepCreateBody:
      "The round + button is always here — new chores, shopping items, family members. You can change everything later.",
    stepPantryTitle: "Pantry keeps the kitchen honest",
    stepPantryBody:
      "Mark what is running low and a shopping list builds itself. Buy it there and it stocks back here.",
    replay: "How this works",
    replayHint: "A quick tour of the main gestures and places.",
  },
  settings: {
    title: "Settings",
    language: "Language",
  ...
  sync: {
    ...
    offlineSaved:
      "You are offline. Your changes are saved and will sync when you\u2019re back online.",
    pending: "{{count}} changes waiting to sync",
    staleWarn:
      "It\u2019s been a while since this device synced. Reconnect when you can.",
    staleStrong:
      "This device hasn\u2019t synced in a long time. Connect to keep the family in step.",
    staleResync:
      "This device is out of date. Reconnect to bring everything back up to date.",
    signUpNudge:
      "Create a free account so the whole family can share this household.",
  },
};
...
export const am: Dict = {
  ...
  today: {
    ...
    whySeeingHint:
      "ይህ ይታያል ምክንያቱም ሥራው ዛሬ ይጠበቃል እና የቤተሰቡ አባል ነዎት። ዕቅዶችን በማንኛውም ጊዜ ማስተካከል ይችላሉ።",
  },
  chores: {
    title: "ሥራዎች",
    mine: "የኔ",
  ...
  household: {
    ...
    resetExplain:
      "ዳግም-አስጀምር ለተገነቡት የፋብሪካ ነባሪዎችን ይመልሳል፣ ለብጁ ሚናዎች ደግሞ የፍጠራ ቅጽበታዊውን።",
    newRole: "አዲስ የሚና ስም",
    noRole: "ሚና የለም",
    owner: "ባለቤት",
    roleLabel: "ሚና",
    ...
    boundarySentence:
      "{{name}} እንደ {{role}} ማድረግ የሚችል ሁሉ ይችላል — ከሚታየው ● በስተቀር።",
  ...
  lock: {
    ...
    recoverWarning:
      "መሣሪያው ብቻውን የሚሰራ ቤተሰብ ከሆነ፦ ማሳረስ በዚህ መሣሪያ ላይ ያለውን መረጃ ይሰርዛል።",
  },
  cal: {
    m1: "መስከረም",
    m2: "ጥቅምት",
  ...
  coach: {
    ...
    stepTodayTitle: "ቀኑን በማውሸጥ አልፉ",
    stepTodayBody:
      "በቀኝ ያንሸራትቱ ሥራውን ለመጨረስ፣ በግራ ያንሸራትቱ ለመዝለል። ክቡን ለመንካት ተጫን — እንደዛሬ አዝራሮችም ይሰራሉ።",
    stepCreateTitle: "በአንድ አዝራር ጨምር",
    stepCreateBody:
      "ዙሪያው + አዝራር ሁልጊዜ እዚህ አለ — አዲስ ሥራዎች፣ የግዢያ እቃዎች፣ የቤተሰብ አባላት። የፈለጉትን ማንኛውም ጊዜ ማስተካከል ይችላሉ።",
    stepPantryTitle: "ማከማቻ ምግብ ቤቱን ይቆጣጠራል",
    stepPantryBody: "የሚያልቅ ነገር ይምልኩ — የግዢያ ዝርዝሩ በራሱ ይሰበሰባል። እዚያ ሲገዙ እዚህ ይሞላል።",
    replay: "እንዴት እንደሚሰራ",
    replayHint: "ዋና ዋና የመንቀሳቀስ መንገዶችንና ቦታዎችን አጭር ጉብኝት።",
  },
  settings: {
    title: "ቅንብሮች",
    language: "ቋንቋ",
    ...
    passcodeExplainSynced:
      "መቆለፊያው የሚሠራው በዚህ መሣሪያ ላይ ነው። ረስተዋል? በመስመር ላይ ሲገቡ የይለፍ ቃሉ ይሳረሳል።",
    passcodeExplainOffline:
