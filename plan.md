...
**Last updated:** Step-8 checkpoint — chores API live. Tree clean at HEAD `a151756`. §12 steps 3–8 ✅ COMPLETE. Suites: core 97/15 ✅ · local-db 16/4 ✅ · web typecheck + `next build` green + live smoke green. NEXT: step 9 home/resources routes. NOTE: GET /today deferred to step 10 (aggregate needs home/resources/social read services).
