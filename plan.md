...
**Last updated:** Step-6 checkpoint — auth API live. Tree clean at HEAD `c1c7ce5`. §12 steps 3 ✅, 4 ✅, 5 ✅, 6 ✅ COMPLETE. Suites: core 97/15 ✅ · local-db 16/4 ✅ · web typecheck + `next build` green + live smoke vs seeded Bekele DB green. NEXT: step 7 people/roles routes.
